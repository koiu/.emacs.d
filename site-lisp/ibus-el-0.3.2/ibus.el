...
If `ibus-python2-shell-command-name' is nil, the script is executed
...
(defcustom ibus-python2-shell-command-name "python2"
  "String specifying shell command of Python2 interpreter, which is
...
;#    (ibus-log "agent filename: %s" file)
    (if ibus-python2-shell-command-name
	(apply 'start-process "ibus-agent" buffer ibus-python2-shell-command-name
